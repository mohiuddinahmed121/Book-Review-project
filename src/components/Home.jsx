...
import imageBook from "../../images/books-8405721_1280.jpg";
      ...
      <div>
         <div className="h-[554px] hero bg-base-200 rounded-lg">
            <div className="hero-content flex-col lg:flex-row-reverse">
               <img src={imageBook} className="max-w-sm rounded-lg shadow-2xl" />
               <div className="mr-28">
                  <h1 className="text-5xl font-bold">
                     Books to freshen up <br /> your bookshelf
                  </h1>
                  <NavLink to="/listedbook" className="btn bg-green-500 text-white mt-10">
                     View The List
                  </NavLink>
               </div>
            </div>
